...
<select id="tipo_Identificacion" type="text" class="form-control" name="tipo_Identificacion" value="{{ old('tipo_Identificacion') }}" required autocomplete="tipo">
   ...
   <option value="nit">Nit</option> 
                         ...
                         <div class="form-group row">
                            <label for="tipo" class="col-md-4 col-form-label text-md-right">{{ __('Numero De Identificacion') }}</label>

                            <div class="col-md-6">
                                <input id="numero_Identificacion" type="text" class="form-control" name="numero_Identificacion" value="{{ old('numero_Identificacion') }}" required autocomplete="tipo">
